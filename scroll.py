def scroll_forward(w, b, half=False):
    """
    Scroll window down.
    """
...
def scroll_backward(w, b, half=False):
    """
    Scroll window up.
    """
...
def scroll_half_page_down(w, b):
    """
    Same as ControlF, but only scroll half a page.
    """
    scroll_forward(w, b, half=True)


def scroll_half_page_up(w, b):
    """
    Same as ControlB, but only scroll half a page.
    """
    scroll_backward(w, b, half=True)


def scroll_one_line_down(w, b):
    """
    scroll_offset += 1
    """
